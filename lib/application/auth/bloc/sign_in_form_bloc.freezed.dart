...
mixin _$SignInFormState {
  ...
  AuthOptionResult get authFailureOrSuccess =>
      throw _privateConstructorUsedError;
...
abstract class $SignInFormStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      bool isSubmiting,
      AuthOptionResult authFailureOrSuccess});
}
...
class _$SignInFormStateImpl implements _SignInFormState {
  ...
  @override
  final AuthOptionResult authFailureOrSuccess;

  @override
  String toString() {
    return 'SignInFormState(emailAddress: $emailAddress, password: $password, showErrorMessages: $showErrorMessages, isSubmiting: $isSubmiting, authFailureOrSuccess: $authFailureOrSuccess)';
  }
...
abstract class _SignInFormState implements SignInFormState {
  const factory _SignInFormState(
          ...
          required final AuthOptionResult authFailureOrSuccess}) =
