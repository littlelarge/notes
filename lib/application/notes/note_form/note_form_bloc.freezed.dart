...
// to showing progress
  ...
  @override
  String toString() {
    return 'NoteFormState(note: $note, showErrorMessages: $showErrorMessages, isEditting: $isEditting, isSaving: $isSaving, saveFailureOrSuccessOption: $saveFailureOrSuccessOption)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, note, showErrorMessages,
      isEditting, isSaving, saveFailureOrSuccessOption);
